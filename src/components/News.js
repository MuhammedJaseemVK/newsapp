...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=60e92e40074843d7a7f0efd1c1d33049&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePrevClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=60e92e40074843d7a7f0efd1c1d33049&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        this.setState({loading:true})
        let data = await fetch(url);
        let parsedData = await data.json();
